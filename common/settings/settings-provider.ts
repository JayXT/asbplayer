...
export const defaultSettings: AsbplayerSettings = {
    ...
    primedListeningReadingTimePerCharacterMs: 60,
    primedListeningMinimumReadingTimeMs: 1000,
    primedListeningMaximumReadingTimeMs: 4000,
    ...
    keyBindSet: {
        ...
        togglePrimedListening: { keys: isMacOs ? '⇧+L' : 'shift+L' },
